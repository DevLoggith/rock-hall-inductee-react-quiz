...
const mockInductees = [
	...
	},
	{
		...
		inductionYear: 2001,
		priorNominations: [],
		inductionPresenter: "Induction Presenter B",
	},
	{
		name: "Test Artist C",
		inductionYear: 2002,
		priorNominations: [2000],
		inductionPresenter: null,
	},
	{
		name: "Test Artist D",
		inductionYear: 2003,
		priorNominations: [2000, 2001],
		inductionPresenter: "Induction Presenter D",
	},
];
...
describe("generateQuestion", () => {
	...
	it("generates unique answer values", () => {
		const question = generateQuestion(mockInductees, []);
